package com.hiepnh.chatapp.traynotifications.notification;

import com.hiepnh.chatapp.JavaFxApplication;
import com.hiepnh.chatapp.traynotifications.animations.*;
import com.hiepnh.chatapp.traynotifications.models.CustomStage;
...
public final class TrayNotification {
    ...
    private void initTrayNotification(String title, String message, NotificationType type) {
        ...
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(JavaFxApplication.class.getResource("/ui/TrayNotification.fxml"));
